...
def evaluation(model):
    ...
    end=start + window_length + 288*310
    ...
    print(f"Evaluation started. number of tests: {cv.get_n_splits(data['Production'])}")
    p = Progress(cv.get_n_splits(data['Production']))
